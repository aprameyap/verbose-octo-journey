...
# Load and prepare the corestick dataset
...
# Load and prepare the imports dataset
...
# Load and prepare the natural gas prices dataset
...
# Load and prepare the exchange rate dataset
...
# Load and prepare the production dataset
...
# Load and prepare the petroleum dataset
...
monthly_df = final_df.resample('M').mean()  # Use mean for aggregation, can also use other methods if necessary

# If you have categorical or other data that need different handling, adjust the resampling method accordingly
# For example, you may want to sum certain columns or take the last available value for others

# Reset index to have DATE as a column again
monthly_df.reset_index(inplace=True)

# Save the monthly dataset to a new CSV file
print(monthly_df)
